...
namespace SmartAttendance.API.Controllers
{
    ...
    public class FacultiesController : ControllerBase
    {
        ...
        {
            // 🌟 التعديل هنا: إضافة Include لجلب الأقسام المتفرعة من كل كلية
        ...
        {
            // 🌟 التعديل هنا أيضاً لجلب الأقسام عند البحث عن كلية معينة
        ...
        {
            // التحقق مما إذا كان الرمز موجوداً مسبقاً
            if (_context.Faculties.Any(f => f.Code == faculty.Code))
            {
                return Conflict(new { message = "رمز الكلية (Code) موجود مسبقاً." });
            }
